const presentationContent = [
    ...
    },
    {
        ...
        points: [
            ...
            "Marcas visuales de seguridad y flujo de procesos.",
    ...
    {
        id: "storage",
        title: "Metodología de Almacenaje Lean",
        content: "Bodegas inteligentes: El pulmón de la operación minera.",
        points: [
            "**Gestión de Repuestos Críticos:** Clasificación por riesgo para asegurar disponibilidad 24/7.",
            "**Sistemas Kanban & VMI:** Reposición automática de reactivos basada en el consumo real.",
            "**Almacén 5S:** Reducción del 30% en tiempos de despacho mediante organización física.",
            "**Inventario JIT:** Reducción de capital inmovilizado en insumos no críticos."
        ]
    },
    {
        id: "system-integration",
        title: "Sinergia: El Sistema Integrado",
        content: "Cómo Lean Six Sigma une la mina, la planta y el almacén.",
        points: [
            "**Eliminación de Silos:** Comunicación fluida entre mantenimiento y almacén (Planificación JIT).",
            "**Reducción de Variabilidad:** Procesos estándar que garantizan el mismo rendimiento en todos los turnos.",
            "**Cultura de Datos:** Decisiones basadas en KPIs compartidos (Costo por Tonelada).",
            "**Sustentabilidad:** Menos desperdicio de recursos e insumos mediante procesos optimizados."
        ]
    },
    {
        id: "program",
